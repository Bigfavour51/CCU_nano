...
#define LV_COLOR_16_SWAP 0 //hb -2.8 inch
// #define LV_COLOR_SCREEN_TRANSP 0 //hb 
// #define LV_COLOR_MIX_ROUND_OFS (LV_COLOR_DEPTH == 32 ? 0: 128) //hb

/*Images pixels with this color will not be drawn if they are chroma keyed)*/
// #define LV_COLOR_CHROMA_KEY lv_color_hex(0x00ff00)         /*pure green*/ //hb
...
#define LV_DEF_REFR_PERIOD  33 //hb -from 15      /*[ms]*/
...
#define LV_CACHE_DEF_SIZE       0  //hb changed from 0 to 1024
